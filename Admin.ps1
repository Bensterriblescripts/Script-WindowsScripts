...
# Set up a new power scheme
powercfg -changename scheme_current "Performance Power Scheme" "Power scheme optimized for blazingly fast laptops."
...
# Set Our New Power Scheme to Active
powercfg -setactive scheme_current

# Disable Troubleshooting
New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\WMI\Autologger\DiagLog" -Name Start -Value 0 -Type DWord -Force
...
# Re-Enable Full Right-Click Context Menus
